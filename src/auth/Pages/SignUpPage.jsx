...
import helmet from '../../assets/non.png'
import bag from '../../assets/balo.png'
import book from '../../assets/sach.png'
import sach from '../../assets/book.png'

import { Gift, Ticket, BadgeDollarSign } from 'lucide-react'
        ...
        <section  className="w-full bg-gradient-to-b from-[#ffffff] to-[#A78FFD] py-10 px-4 sm:p-4 p-2 min-w-[400px]">
            <div className="max-w-[1280px] mx-auto flex flex-col md:flex-row md:gap-10 items-center justify-center gap-20 relative">
                ...
                <div className="hidden xxl:block">
                    <div className="w-50 absolute top-70 right-0"><img src={bag} alt="balo" /></div>
                    <div className="w-58 absolute top-75 -right-30"><img src={bag} alt="balo" /></div>
                    <div className="w-24 absolute top-96 right-30 -rotate-12"><img src={book} alt="sach" /></div>
                    <div className="w-24 absolute bottom-32 right-22 -rotate-12"><img src={book} alt="sach" /></div>
                    <div className="w-24 absolute bottom-18 -right-24 rotate-12"><img src={sach} alt="sach" /></div>
                    <div className="w-24 absolute bottom-24 -right-18 rotate-12"><img src={sach} alt="sach" /></div>
                    <div className="w-24 absolute bottom-18 right-4"><img src={helmet} alt="non" /></div>
