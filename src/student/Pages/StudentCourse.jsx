...
const StudentCourse = () => {
    ...
    const handleCourseClick = (course) => {
        navigate(`/my-courses/view/${course.courseId}`, { state: { course } });
    };
    ...
    if (!user) {
        return (
            <div className="p-6 max-w-[1200px] mx-auto min-h-screen mt-20">
                <h2 className="text-xl text-red-500 font-semibold">Vui lòng đăng nhập để xem khóa học của bạn</h2>
            </div>
        );
    }
    ...
    return (
        <div className="p-6 max-w-[1200px] mx-auto min-h-screen mt-20">
            <h1 className="text-2xl font-bold text-orange-600 mb-4">Hello, {user?.email}</h1>
            <div className="border rounded p-4">
                <h2 className="text-xl font-semibold text-orange-500 mb-4">Tổng quan về khóa học</h2>
