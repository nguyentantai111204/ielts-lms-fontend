...
import { reviewSubmission } from "../Services/TestOnlineService";


const HistoryTestDetailPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-4 md:p-8 mt-[80px]">
...
export default HistoryTestDetailPage;
